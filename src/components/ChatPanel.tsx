...
export function ChatPanel({
  ...
  if (isMinimized) {
    return (
      <motion.button
        ...
        className={`fixed z-20 w-12 h-12 rounded-full flex items-center justify-center ${isMobile ? "bottom-4 right-4" : "top-[92px] right-6"}`}
        style={{
  ...
  if (!isExpanded) {
    ...
    return (
      <motion.div
        ...
        className={`fixed z-20 ${isMobile ? "bottom-3 left-3 right-3" : "top-[92px] right-6"}`}
        ...
        <div className="liquid-glass-panel rounded-[1.5rem] p-1.5">
          <div className="flex items-center gap-2 px-4 py-2.5">
            ...
            <textarea
              ...
              placeholder="Frage den Agorix Assistenten..."
              rows={1}
  ...
  return (
    <motion.section
      ...
      transition={{ type: "spring", stiffness: 300, damping: 25 }}
      className={`fixed z-20 flex flex-col liquid-glass-panel rounded-[1.5rem] overflow-hidden ${isMobile ? "bottom-3 left-3 right-3" : "top-[92px] right-6"}`}
